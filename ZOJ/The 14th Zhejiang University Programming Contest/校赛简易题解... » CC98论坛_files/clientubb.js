...
function parseAndFilterArgs(str, allowedArgsTable) {
...
function ubbUploadReplaceFunc(all, type, _unused1, _unused2, url) {
	...
	if (linkPath != null) {
		return String.format('<br /><img src="{0}{1}.gif" title="文件图标" border="0" style="border-style: none;"> <a href="{2}" title="浏览文件" />点击浏览该文件</a>&nbsp;&nbsp;<a title="下载" href="{3}">直接下载</a>', icondir, escape(type), linkPath, url);
	}
	else {
...
var codeUbb = function (source, language) {
	...
	source = '<table style="width:100%" cellpadding=5 cellspacing=1 class=tableborder1 class="code"><tr><TD class="' + tdclass + '" width="100%" onDblClick="copy2cb(ubb.storage.codeSource[\'' + ubb.num['code'].toString() + '\'])"><div style="overflow:auto;"><font face="' + fo + '">' + strf + '</font></div></td></tr></table>';
	return source;
}
